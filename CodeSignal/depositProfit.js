...
// For deposit = 100, rate = 20, and threshold = 170, the output
// should be depositProfit(deposit, rate, threshold) = 3;
...
const depositProfit = (deposit, income, rate, threshold) => {
  let current = deposit;
  rate = rate / 100;
  let years = 0;
...
console.log(depositProfit(30000, 150000, 7, 3000000));
